...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] = {
  { FRAMEWIN_CreateIndirect, "PWM Control", ID_FRAMEWIN_0, 0, 0, 800, 480, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "tb_dianya", ID_EDIT_0, 133, 262, 80, 30, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "tb_dianliu", ID_EDIT_1, 130, 311, 80, 30, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "voltage", ID_TEXT_0, 36, 270, 80, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "current", ID_TEXT_1, 34, 314, 80, 20, 0, 0x0, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_2, 392, 258, 80, 30, 0, 0x64, 0 },
  { EDIT_CreateIndirect, "Edit", ID_EDIT_3, 395, 319, 80, 30, 0, 0x64, 0 },
  { TEXT_CreateIndirect, "pulse width", ID_TEXT_2, 291, 326, 80, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "frequency", ID_TEXT_3, 292, 267, 80, 20, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "START", ID_BUTTON_0, 562, 256, 80, 30, 0, 0x0, 0 },
  { BUTTON_CreateIndirect, "STOP", ID_BUTTON_1, 565, 316, 80, 30, 0, 0x0, 0 },
...
*       CreatePWM Control
*/
WM_HWIN CreatePWM Control(void);
WM_HWIN CreatePWM Control(void) {
  WM_HWIN hWin;
